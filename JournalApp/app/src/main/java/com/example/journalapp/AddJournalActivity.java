            ...
            filepath.putFile(imageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            /*
                             The getDownloadURL() method returns a promise that resolves with the download URL for the file.
                     The download URL is a long-lived, publicly accessible URL that can be used to access the file from Cloud Storage.
                                     */
