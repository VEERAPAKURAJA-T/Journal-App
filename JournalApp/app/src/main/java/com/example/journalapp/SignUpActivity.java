...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Firebase Auth require Google Account on the device to run successfully .Otherwise it will not run
        /*
        We need to configure the Google play services and play store on the emulator.
So Firebase Firebase Authentication requires the presence of Google Services and Google Account on your
emulator.And in order to configure the Android emulator, you need to to enable and download the services
         */
